<template>
  ...
  <div class="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
    <div class="mx-auto max-w-2xl text-center">
      <h2 data-aos="fade-up" class="text-base/7 font-semibold text-indigo-400">Get started</h2>
      <p data-aos="fade-up" class="mt-2 text-balance text-3xl font-semibold tracking-tight text-white sm:text-5xl">Reliable employee transport for your company.</p>
      <p data-aos="fade-up" class="mx-auto mt-6 max-w-xl text-sm text-pretty lg:text-lg/8 text-gray-400">Help employees get to work safely, comfortably, and on time. Here's an employee perk that actually matters every day.</p>
    ...
    <div class="mt-24 border-t border-white/10 pt-12 xl:grid xl:grid-cols-3 xl:gap-8">
      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            <h3 data-aos="fade-up" class="text-sm/6 font-semibold text-white">Company</h3>
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">About Us</a>
              </li>
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">Contact Us</a>
              </li>
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">Become a partner</a>
              </li>
              <!-- <li>
          ...
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">Terms of service</a>
              </li>
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">Privacy policy</a>
              </li>
              <li>
                <a data-aos="fade-up" href="#" class="text-sm/6 text-gray-400 hover:text-white">License</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="mt-12 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
      <div class="flex gap-x-6 md:order-2">
        <a data-aos="fade-up" href="#" class="text-gray-400 hover:text-gray-300">
