<template>
    <div class="max-w-7xl mx-auto px-4 py-16 text-center">
      <div class="inline-block px-4 py-1 mb-6 bg-gray-50 rounded-full">
        <span class="text-blue-500 font-medium">Metrics</span>
      </div>
      
      <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4 -mt-2">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-[#F8F9FF] rounded-3xl p-8">
          <div class="text-[#2D41A7] text-5xl font-bold mb-4">
            {{ numberWithCommas(currentValues.staff) }}+
          </div>
          <h3 class="text-gray-900 text-xl font-semibold mb-2">Staff moved</h3>
        ...
        <div class="bg-[#F8F9FF] rounded-3xl p-8">
          ...
          <h3 class="text-gray-900 text-xl font-semibold mb-2">Business Clients</h3>
          <p class="text-gray-600 text-sm">
            Our clients have about 10k+ staff that use our Shuttles.
          </p>
        </div>
        ...
        <div class="bg-[#F8F9FF] rounded-3xl p-8">
          ...
          <h3 class="text-gray-900 text-xl font-semibold mb-2">Trips Taken</h3>
          <p class="text-gray-600 text-sm">
        ...
        <div class="bg-[#F8F9FF] rounded-3xl p-8">
          ...
          <h3 class="text-gray-900 text-xl font-semibold mb-2">Vehicles</h3>
          <p class="text-gray-600 text-sm">
