<template>
  <main class="grid p-6 lg:p-0 lg:grid-cols-2 gap-6 max-w-7xl mx-auto">
    <div class="relative w-full overflow-hidden rounded-2xl shadow-lg group">
      ...
      <div
        class="absolute inset-0 flex flex-col justify-center bg-blue-600 text-white p-6 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
        <div class="flex items-center space-x-2 mb-4">
          ...
          <h3 class="text-lg font-semibold">Seamless commuting</h3>
        </div>
        ...
        <button class="mt-4 px-4 py-3 bg-white text-blue-600 font-semibold rounded-full hover:bg-gray-100">
          Learn More
        </button>
      </div>
  
      <!-- Card Content (Visible initially) -->
      <div class="absolute bottom-0 left-0 w-full bg-white p-4 rounded-b-2xl group-hover:opacity-0 transition-opacity duration-300">
    ...
    <div class="relative w-full overflow-hidden rounded-2xl shadow-lg group">
      ...
      >
        <div class="flex items-center space-x-2 mb-4">
          ...
          <h3 class="text-lg font-semibold">Affordable Pricing
        </h3>
        </div>
        <p class="text-sm leading-6">
    ...
    <div class="relative w-full overflow-hidden rounded-2xl shadow-lg group">
      ...
      >
        <div class="flex items-center space-x-2 mb-4">
          ...
          <h3 class="text-lg font-semibold">Smart Drivers</h3>
        </div>
        <p class="text-sm leading-6">
      ...
      <!-- Card Content (Visible initially) -->
      <div class="absolute bottom-0 left-0 w-full bg-white p-4 rounded-b-2xl group-hover:opacity-0 transition-opacity duration-300">
        <h3 class="text-lg font-semibold text-gray-900">Nextride for schols</h3>
        <p class="text-sm text-gray-500">
          Help employees get to work safely, comfortably, and on time. Here's an employee pe...
        </p>
      </div>
  ...
  const imageSrc = 'https://via.placeholder.com/400x300' // Replace with actual image source
  </script>
  
  <style scoped>
  /* Group styling for hover effects to target child elements */
  </style>
