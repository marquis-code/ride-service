...
<main class="flex flex-col items-center justify-center mt-10">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-32 pt-36 sm:pt-60 lg:px-8 lg:pt-32">
          <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
            <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
              <h1 class="text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Reliable employee transport for your company.</h1>
              <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:max-w-md sm:text-xl/8 lg:max-w-none">Help employees get to work safely, comfortably, and on time. Here's an employee perk that actually matters every day.</p>
  ...
  <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
    <div class="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
      ...
      <h1 class="mt-10 text-pretty text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Reliable employee transport for your company.</h1>
      <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">Help employees get to work safely, comfortably, and on time. Here's an employee perk that actually matters every day.</p>
      <div class="mt-10 flex items-center gap-x-6">
    ...
    <div class="mx-auto mt-16 flex max-w-2xl sm:mt-24 lg:ml-10 lg:mr-0 lg:mt-0 lg:max-w-none lg:flex-none xl:ml-32">
      <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
        <div class="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
          <img src="@/assets/img/girls.jpg" alt="App screenshot" width="2432" height="142" class="w-[76rem] rounded-md shadow-2xl ring-1 ring-gray-900/10">
        </div>
      </div>
    </div>
  </div>
...
>
  ...
  <div class="relative z-10 text-center px-4">
    <h1 class="text-white text-5xl font-semibold mt-20 max-w-2xl mx-auto mb-10">
      Move Together, Effortlessly: Choose Nextride
    </h1>

    <p class="text-center max-w-2xl mx-auto  text-xl my-10 text-white/90">
