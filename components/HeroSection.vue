...
<section>
  <div class="bg-gray-900">
    ...
    <div class="relative isolate overflow-hidden pt-14">
      <!-- Video background -->
      <video autoplay loop muted class="absolute inset-0 -z-10 object-cover w-full h-full">
        <source src="/drive1.mp4" type="video/mp4">
        Your browser does not support the video tag.
      </video>

      <!-- Dark background overlay on top of the video -->
      <div class="absolute inset-0 bg-black opacity-50 -z-10"></div>

      <!-- Gradient overlay on top of the video -->
      <div class="absolute inset-0 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80" aria-hidden="true">
      ...
      <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div class="text-center text-white">
            <!-- Main Heading -->
            <h1 class="text-5xl font-semibold tracking-tight sm:text-7xl">Find, book, and hire vehicle in Easy steps.</h1>
            <!-- Subheading -->
            <p class="mt-8 text-lg font-medium sm:text-xl/8">Help employees get to work safely, comfortably, and on time. Here's an employee perk that actually matters every day.
